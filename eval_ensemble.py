...
batch_size = 20
max_iterations = 300
input_path = './dataset/white_images/'
...
np.save("exp_results/ensemble-based-attacks/X_adv_Inc-v3_Dense121_VGG16_300iters_Logit_white.npy", X_adv)
np.savetxt("exp_results/ensemble-based-attacks/succ_rate_Inc-v3_Dense121_VGG16_every_20iters_Logit_white.txt", pos/10, fmt="%.1f", delimiter=",")
